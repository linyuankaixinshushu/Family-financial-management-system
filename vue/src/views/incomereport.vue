    ...
    <div>
            ...
            <el-col :span="24">
                <el-card>
                    <div style="display: flex;margin-left: 30px">
                        <div style="font-weight: bold"><h2>收入构成</h2></div>
        ...
        <el-row style="margin-top: 40px">
            <el-col :span="24">
                <el-card>
                    <div style="display: flex;margin-left: 30px">
                        <div style="font-weight: bold"><h2>收入折线图</h2></div>
                        <div style="margin-left: 50px;">
...
export default {
    ...
    methods: {
        ...
        loadincomebyuser(time) {
            this.request.get("/echarts/incomebyuser",{
                params:{
                    begintime: time[0],
                    endtime: time[1],
                }
        ...
        loadline() {
            this.request.get("/echarts/getfamilyincomeop", {
                params:{
                    time : this.linetime,
                    flag : this.flag,
                    len : this.linelen,
