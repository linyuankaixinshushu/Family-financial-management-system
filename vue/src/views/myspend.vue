<template>
    <div>
        ...
        <el-table :data="tableData" border strip header-cell-class-name="headerBg">
            ...
            <el-table-column prop="fromway" label="支付方式" width="120">
            </el-table-column>
...
export default {
    ...
    methods: {
        load() {
            this.request.get("/spenddetail/page", {
                params: {
        ...
        add_report(){
            ...
            this.request.post("spenddetail/save", {
        ...
        del_user(row) {
            this.request.delete("/spenddetail/del", {
                params: {
                    id: row.id,
                    username: this.user.data.username,
                    fromway: row.fromway,
